...
# ==========================================
# Ask about trail trajectory
# ==========================================

trail_option = input("Enable trajectory trail? (1 = yes, 0 = no): ").strip()

if trail_option == "1":
    draw_trail = True
    print("Trajectory trail enabled.")
else:
    draw_trail = False
    print("Trajectory trail disabled.")
...
# Store the tracked object positions
trail_points = []
...
for path in frame_files:
    ...
    if draw_trail and len(trail_points) > 1:
    ...
    cv2.putText(
        img_color,
        f"Method: {method_name} (adaptive template)",
        (10, 30),
